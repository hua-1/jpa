...
public class SendRedEnvelope {
    ...
    public static void addMap(){
        map.put(IdentityEnum.NEW_USER.index,IdentityEnum)
    }
    /**
     * 计算用户 钱 身份 红包id 红包数量
     * @param money
     ...
     * @return
     */
    public void   getSendResult(int money, int identityEnum, List<Integer> envelopeId, int envelopeNumber, User user){
        switch (IdentityEnum.get(identityEnum)){
            case NEW_USER:
